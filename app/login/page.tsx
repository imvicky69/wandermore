    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream via-white to-brand-green/10">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-brand-green/20">
        <div className="text-center mb-8">
          ...
          <p className="text-brand-green/70">Share your journey with the world</p>
        </div>

        <div className="space-y-4">
          <button
            onClick={handleGoogleSignIn}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-brand-green/30 text-brand-green px-6 py-3 rounded-lg hover:bg-brand-green/5 transition-all duration-200 font-semibold"
          >
          ...
          <div className="text-center">
            <p className="text-brand-green/70 mb-4">
              ...
              <a href="/signup" className="text-brand-blue font-semibold hover:underline">
                Sign up
              </a>
            </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-brand-green/10">
          <p className="text-center text-xs text-brand-green/50">
            By continuing, you agree to Wandermore&apos;s Terms of Service and Privacy Policy
          </p>
        </div>
      </div>
    </div>
